...
import { personalInfo, skills, experience, projects, education, certifications } from "@/lib/data";
      ...
      <section className="py-16 px-6 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">Portfólio de projetos que demonstram minhas habilidades técnicas</p>
          </div>
      ...
      <section className="py-16 px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">Certificações técnicas que comprovam minha expertise</p>
          </div>
              ...
              <Card key={index} className="shadow-lg hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-2">
                    {cert.certs.map((certName, certIndex) => (
